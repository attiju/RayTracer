...
Spectrum::Spectrum(Float v) : x(v), y(v), z(v) {

}

Spectrum::Spectrum(Float x, Float y, Float z) : x(x), y(y), z(z) {

}

template<typename T>
Spectrum::Spectrum(const Point3<T> v) : x(v.x), y(v.y), z(v.z) {

}

template<typename T>
Spectrum::Spectrum(const Vector3<T> v) : x(v.x), y(v.y), z(v.z) {

}

template<typename T>
Spectrum::Spectrum(const Normal3<T> v) : x(v.x), y(v.y), z(v.z) {
